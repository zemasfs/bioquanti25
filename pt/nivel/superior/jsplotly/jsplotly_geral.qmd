---
title: "JSPlotly e Simulação Interativa em Ciências Naturais"
format: html
toc: true
lang: pt
---
...
|   Permite a reprodução, modificação, criação e compartilhamento de gráficos e painéis interativos em 2D ou 3D, juntamente a seus códigos. Foi concebido como uma alternativa simples, rápida, aberta, lúdica, reprodutível e compartilhável ao ensino-aprendizagem e pesquisa. 
...
|   A atual versão do programa pode ser visualizada diretamente abaixo.

|     [JSPlotly_1.0](JSPlotly_1.0.html)


|   Observe que, por tratar-se de um arquivo HTML, o aplicativo abre em qualquer visualizador, como Chrome, Firefox, Safari, etc. Como também abre em desktop e dispositivos móveis, e de modo online, ou offline.
