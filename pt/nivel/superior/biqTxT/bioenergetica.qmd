...
![Representação do acoplamento energético, exemplificando a primeira reação não espontânea do metabolismo da glicose.](engrenag.png){#fig-engrenag}
...
![Exemplos de coenzimas celulares. a - NADH, nicotinamida adenina dinucleotídeo, utilizada em processos de geração de energia celular; b - NADPH, nicotinamida adenina dinucleotídeo fosfato, utilização na síntese de lipídios e no metabolismo de radicais livres da célula.; c – ATP, adenosina trifosfato, a moeda de troca energética da célula; d – FADH2, flavina adenina dinucleotídeo, molécula de função similar a NADH. Os átomos de fósforo estão representados em preto.](coenzOxRed.png){#fig-coenzOxRed}
...
![DNAligase tendo ao centro a combinação com  uma molécula de ATP.](DNAligase.png){#fig-DNAligase}
...
![Rotas gerais do metabolismo celular. As setas para cima indicam caminhos anabólicos, enquanto que as setas para baixo indicam caminhos catabólicos.](mapageral.png){#fig-mapageral}
...
![Estrutura da molécula de acetil coenzima A, ou acetil CoA, composto central do metabolismo celular, derivado da vitamina ácido pantotênico.](acetiCoA.png){#fig-acetiCoA}

|       Se observamos esse mapa de forma mais detalhada, veremos surgir um conjunto maior de inter-relações bioquímicas.

![Principais rotas bioquímcas do metabolismo celular representadas num pequeno *mapa metabólico*.](mapametab.png){#fig-mapametab}
...
![Mapa metabólico de referência para as rotas bioquímicas do metabolismo celular.](mapagrandao.png){#fig-mapagrandao}
...
![Valores de potencial de oxi-redução para algumas reações metabólicas.](tabelaOxRed.png){#fig-tabelaOxRed}
