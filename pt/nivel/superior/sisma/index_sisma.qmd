...
|   À despeito da usabilidade facilitada por mouse, sem a necessidade de inserção de comandos de texto, o *Sisma* faculta a modificação de todos os elementos do mapa (objetos, caminhos, equações, nomes, cores, posições) por edição do arquivo do mapa em bloco de notas, agregando valor a um *Ensino Reprodutível* com a ferramenta.
...
|   Segue uma sequência de alguns experimentos virtuais que passíveis de execução e estudo pelo *Sisma*. 
