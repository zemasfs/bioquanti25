...
1. O OIER propriamente dito, com título e códigos *BNCC*;
1. O código-fonte usado para gerar o objeto;
1. Sugestões para modificações do código-fonte para obtenção de um objeto final distinto do original.