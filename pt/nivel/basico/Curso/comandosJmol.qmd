...
|       Proteínas, enzimas, ácidos nucleicos, e associações macromoleculares são mais pertinentes ao estudo da *Bioquímica* estrutural. Nesse sentido lhe convido a visitar uma parte do *website* que possui descrições e representações detalhadas de estruturas da [Bioquímica](nivel/superior/jmol/index_jmol.html) com auxílio do *Jmol*.
