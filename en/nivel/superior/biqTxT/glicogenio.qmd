---
title: "Metabolismo do Glicogênio"
lang: pt
---
...
1. Entender o que representa a glicogênese e a glicogenólise, sabendo localizá-las no mapa;
1. Compreender como se dá a ativação de glicose-6-P para a síntese do glicogênio;
1. Saber as etapas básicas do metabolismo de síntese (ativação/ancoragem, elongamento, ramificação) e de degração do glicogênio;
(desramificação/encurtamento, dextrina limite)
1. Saber o que é a glicogenina e seu papel na síntese do glicogênio; 
1. Entender como funciona a glicogênio fosforilase e sua dependência de vitamina B6;
1. Compreender o papel da modulação covalente nas enzimas chave do metabolismo do glicogênio;
1. Entender o papel do AMP-cíclico para a degradação do glicogênio;
1. Saber exemplificar como a fosforilação da glicogênio sintase e da fosforilase atuam em conjunto com outros vias metabólicas de glicose;
1. Saber exemplificar alguns controles alostéricos do metabolismo do glicogênio;
1. Entender o papel do glicagon e da insulina para o metabolismo do glicogênio.
...
![Lógica de síntese e degradação de glicogênio.](glicogenResum.png){#fig-glicogenResum}
...
![Eventos resumidos da síntese e degradação de glicogênio na célula.](metabGlicog.png){#fig-metabGlicog}
...
![Fragmento de uma molécula ramificada de glicogênio.](ramoGlicog.png){#fig-ramoGlicog}
...
1. Conceito: síntese e degradação, tendo a glicose como unidade formadora;
1. Importância: armazenamento (síntese) e provimento (degradação) de glicose, dependendo das necessidades do organismo;
1. Localização: citosol hepático e muscular, principamente
1. Lógica da via de síntese: síntese de precursor (UDP-glicose), alongamento da cadeia (Glc-Glc-Glc-etc) e ramificação;
1. Lógica da via de degradação: encurtamento da cadeia e desramificação simultâneos, e conversão a glicose-6-P;
1. Regulação da degradação: saciedade (+), cálcio (+), insulina (-);
1. Doenças: doença de von Gierke (deficiência da glicose-6-fosfatase, levando a esteatose e hipoglicemia severa); doença de Andersen (deficiência na enzima
desramificadora, levando a cirrose hepática infantil progressiva e morte); doença de Pompe (acúmulo de glicogênio nos vacúolos lisossômicos por deficiêncie de -1,4-glicosidade, ocasionando a doença de depósito de glicogênio tipo II).
